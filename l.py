...
def save_table_info_to_file(table_info, file_path):
    with open(file_path, 'w') as file:
        file.write(f"entity: {table_info.name}\n")
        file.write("attributes: " + ', '.join([column.name for column in table_info.columns]) + "\n")
        file.write("primary key: " + ', '.join(table_info.primary_keys) + "\n")
